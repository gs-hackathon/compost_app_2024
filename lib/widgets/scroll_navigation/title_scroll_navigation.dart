...
class TitleScrollNavigation extends StatefulWidget {
  const TitleScrollNavigation({
    ...
    NavigationBodyStyle bodyStyle = const NavigationBodyStyle(),
    TitleNavigationBarStyle barStyle = const TitleNavigationBarStyle(),
    NavigationIdentiferStyle identiferStyle = const NavigationIdentiferStyle(),
  })  : assert(titles.length == pages.length),
        barStyle = barStyle ?? const TitleNavigationBarStyle(),
  ...
  @override
  TitleScrollNavigationState createState() => TitleScrollNavigationState();
}

class TitleScrollNavigationState extends State<TitleScrollNavigation> {
  ...
  final _IdentifierProps _identifier = _IdentifierProps(0.0, 0.0);
  final List<_TitleProps> _titlesProps = [];
